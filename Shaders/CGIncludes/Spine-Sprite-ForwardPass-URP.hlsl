...
///////////////////////////////////////////////////////////////////////////////
half3 UniversalRPLightVertexSimplified(float3 positionWS, half3 normalWS) {
...
half4 UniversalRPFragmentPBRSimplified(InputData inputData, half4 texAlbedoAlpha, half metallic, half3 specular,
...
half4 UniversalRPFragmentBlinnPhongSimplified(InputData inputData, half4 texDiffuseAlpha, half3 emission, half4 vertexColor)
{
...
VertexOutputLWRP ForwardPassVertexSprite(VertexInput input)
{
	...
	output.fogFactorAndVertexLight.yzw = UniversalRPLightVertexSimplified(positionWS, normalWS);
...
half4 ForwardPassFragmentSprite(VertexOutputLWRP input) : SV_Target
{
	...
	half4 pixel = UniversalRPFragmentPBRSimplified(inputData, texureColor, metallic, specular, smoothness, emission.rgb, input.vertexColor);
#else
	half3 emission = half3(0, 0, 0);
	APPLY_EMISSION(emission, input.texcoord.xy)
	half4 pixel = UniversalRPFragmentBlinnPhongSimplified(inputData, texureColor, emission, input.vertexColor);
#endif
